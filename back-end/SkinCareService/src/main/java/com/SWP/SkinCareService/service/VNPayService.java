...
public class VNPayService {
    ...
    public String createPaymentUrl(@NonNull VNPayPaymentRequestDTO requestDTO, @NonNull String ipAddress) {
        ...
        try {
            ...
            log.info("Created payment URL for TxnRef: {}, Amount: {}", vnp_Params.get("vnp_TxnRef"), requestDTO.getAmount());
            return fullUrl;
    ...
    private void validateCreatePaymentRequest(VNPayPaymentRequestDTO requestDTO, String ipAddress) {
        ...
        if (requestDTO.getAmount() <= 0) {
            throw new AppException(ErrorCode.VNPAY_INVALID_AMOUNT);
        }
        
        if (!StringUtils.hasText(requestDTO.getOrderInfo())) {
    ...
    private Map<String, String> buildPaymentParams(VNPayPaymentRequestDTO requestDTO, String ipAddress) {
        ...
        vnp_Params.put("vnp_OrderType", requestDTO.getOrderType());
    ...
    private Map<String, Object> buildPaymentResult(Map<String, String> response) {
        ...
        if (isSuccess) {
            ...
            log.info("Payment successful - TxnRef: {}, Amount: {}", transactionRef, amount);
        } else {
    ...
    private String getResponseMessage(String responseCode) {
        return switch (responseCode) {
            ...
            case "09" -> "Giao dịch không thành công do: Thẻ/Tài khoản của khách hàng chưa đăng ký dịch vụ Internet Banking tại ngân hàng";
